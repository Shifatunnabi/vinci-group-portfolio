                ...
                <div className="row justify-content-center">
                    <div className="col-12">
                        <div className="section-title text-center" style={{marginTop: '60px', paddingTop: '40px', marginBottom: '50px'}}>
                            <h2 style={{fontSize: '48px', fontWeight: 'bold', marginBottom: '20px'}}>What Our Clients Say</h2>
                            <p style={{fontSize: '18px', color: '#687693', maxWidth: '600px', margin: '0 auto', lineHeight: '1.6'}}>
                                Read testimonials from our satisfied clients who have experienced our exceptional services and solutions
                            </p>
                        </div>
                    </div>
                </div>
                            ...
                            <div className="testimonial-card" key={titem}>
                                ...
                                <div className="client">
                                    <div className="client-img">
                                        <Image src={testitem.img} height={70} width={70} alt="" />
                                    </div>
