...
import psingle1 from "/public/images/project-single/2.jpg";
import psingle2 from "/public/images/project-single/3.jpg";
import Image from "next/image";

const ProjectSingle = (props) => {
  const router = useRouter();

  const ProjectSingle = Projects.find(
              ...
              <div className="wpo-project-single-wrap">
                <div className="wpo-project-single-item">
                    ...
                    <div className="col-lg-5">
                      <div className="wpo-project-single-content-des-right">
                        <ul>
                          ...
                          <li>
                            Project Type :<span>Investment planning</span>
                          </li>
                          <li>
                            Duration :<span>6 Month</span>
                          </li>
                          <li>
                            Completion :<span>{ProjectSingle?.date}</span>
                          </li>
                          <li>
                            Share :<span>Consulting, Business</span>
                          </li>
                        </ul>
                      </div>
                    </div>
                  ...
                  <div className="wpo-project-single-main-img">
                    <Image
                      src={ProjectSingle?.pSimg}
                      alt={ProjectSingle?.title || "Project image"}
                    />
                  </div>
                </div>
